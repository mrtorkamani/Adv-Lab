...
try:
	datatab = ascii.read('/home/mr/Desktop/Lab/S262/Report/code/refrence data/ref2-dec_still/movedata_out.txt') #Put your Declination Scan datafile in here
...
plt.title(r'\textbf{Raw Data antena A}')
...
plt.xlabel(r'\textbf{Time}')
plt.ylabel(r'\textbf{Intensity}')
plt.title(r'\textbf{Raw Data antena B}')
...
plt.xlabel(r'\textbf{Time}')
plt.ylabel(r'\textbf{Intensity}')
plt.title(r'\textbf{Denoised Data antena B}')
...
plt.xlabel("RA [deg]")
plt.ylabel("Dec [deg]")
plt.axvline(x=188.3,color='black')
plt.axvline(x=188.95 ,color='black')
plt.grid(True)
